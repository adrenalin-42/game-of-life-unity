...
public class Grid
{
    ...
    private Transform cubesParentTransform;
    ...
    public Grid(int width, int height, float cellSize, Vector3 originPosition)
    {
        ...
        // Organizing purposes
        this.cubesParent = new GameObject("RectanglesGroup");
        this.cubesParentTransform = cubesParent.transform;
    }
    ...
    public void RemoveLines()
    {
        for (int i = 0; i < gridArray.GetLength(0); i++)
        {
            for (int j = 0; j < gridArray.GetLength(1); j++)
            {
                GameObject.Destroy(GameObject.Find("Line_1_" + i + "_" + j));
                GameObject.Destroy(GameObject.Find("Line_2_" + i + "_" + j));
            }
        }
        GameObject.Destroy(GameObject.Find("Line_3_1"));
        GameObject.Destroy(GameObject.Find("Line_3_2"));
    }
    ...
    public void DrawRectangle(Color color, int x, int y, Transform parent = null)
    {
        ...
        myGO.transform.SetParent(cubesParentTransform, false);
